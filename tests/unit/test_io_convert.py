...
#
# # ##############################################
# # # HDMF Baz test compound dataset of references
# # ##############################################
# # class MixinTestBaz2():
# #     """
# #     Mixin class used in conjunction with MixinTestCaseConvert to test a compound
# #     dataset of references.
# #
# #     Mixin class used in conjunction with MixinTestCaseConvert to create conversion tests that
# #     test export of a compound dataset of references. This class only defines the setUpContainer
# #     and get_manager functions. The roundtripExportContainer function required for
# #     the test needs to be defined separately, e.g., MixinTestZarrToHDF5,  MixinTestHDF5ToZarr,
# #     or MixinTestZarrToZarr.
# #     """
...
# #         baz_cpd_data = BazCpdData(name='baz_cpd_data1', data=baz_pairs)
# #
# #         bucket = BazBucket(bazs=bazs, baz_data=baz_data, baz_cpd_data=baz_cpd_data)
# #         return bucket
#
# ########################################
...
#
#
# # class TestZarrToHDF5Baz2(MixinTestBaz2,
# #                          MixinTestZarrToHDF5,
# #                          MixinTestCaseConvert,
# #                          TestCase):
# #     """
...
# #
# #
# # class TestHDF5toZarrBaz2(MixinTestBaz2,
# #                          MixinTestHDF5ToZarr,
# #                          MixinTestCaseConvert,
# #                          TestCase):
# #     """
...
# #
# #
# # class TestZarrtoZarrBaz2(MixinTestBaz2,
# #                          MixinTestZarrToZarr,
# #                          MixinTestCaseConvert,
# #                          TestCase):
# #     """

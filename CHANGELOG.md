...
* Fixed bug where exporting a file whose path contains a symlinked component wrote external links instead of copying the data. @rly [#386](https://github.com/hdmf-dev/hdmf-zarr/pull/386)
